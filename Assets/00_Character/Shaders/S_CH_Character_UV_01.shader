...
Shader "Custom/UV_Flip_01"
{
	...
	SubShader
	{
		...
		uniform float _Eye_X_Scale;
		uniform float _Eye_Y_Scale;
		uniform int _Eye;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_35_0_g33 = frac( ( ( (float)_Eye + clampResult42_g33 ) / totalFrames39_g33 ) );
			float2 appendResult29_g33 = (float2(temp_output_35_0_g33 , ( 1.0 - temp_output_35_0_g33 )));
			float2 temp_output_15_0_g33 = ( ( ( ( ( i.uv_texcoord * appendResult1976 ) + 0.5 ) - ( appendResult1976 / 2.0 ) ) / appendResult7_g33 ) + ( floor( ( appendResult8_g33 * appendResult29_g33 ) ) / appendResult7_g33 ) );
...
Node;AmplifyShaderEditor.SamplerNode;541;336,-368;Inherit;True;Property;_Diffuse_Texture;Diffuse_Texture;1;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;f90840bf7c50fd848b0eb5fa0ef718d0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1968;-142.0613,26.13134;Inherit;False;Property;_Eye_X_Scale;Eye_X_Scale;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1975;-143.0613,102.1315;Inherit;False;Property;_Eye_Y_Scale;Eye_Y_Scale;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0B13085ABB2A4C54C10A0BA4B9FB3812C2BF55B2